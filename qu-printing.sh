...
# Old-school printer install shell script for Quinnipiac campus printing
# Works with Linux and macOS
#
# Written by Joey Germain
# 10/31/2018
#
# TODO: verify that printers actually install, remove old printers, add option to use command-line parameters as username
...
echo "Printers installed sucessfully."
